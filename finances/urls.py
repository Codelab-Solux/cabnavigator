...
urlpatterns = [
    ...
    path('expenses/v_expense/create', create_v_expense, name='create_v_expense'),
    path('expenses/v_expense/<str:pk>/', v_expense, name='v_expense'),
    path('expenses/v_expense/<str:pk>/edit',
         edit_v_expense, name='edit_v_expense'),
    path('expenses/v_expense/<str:pk>/delete',
         delete_v_expense, name='delete_v_expense'),
    # global expenses
    path('g_expenses/', g_expenses, name='g_expenses'),
    path('expenses/g_expense/create', create_g_expense, name='create_g_expense'),
    path('expenses/g_expense/<str:pk>/', g_expense, name='g_expense'),
    path('expenses/g_expense/<str:pk>/edit',
         edit_g_expense, name='edit_g_expense'),
    path('expenses/g_expense/<str:pk>/delete',
